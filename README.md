...
No. Any text editor works. Any AI chat works. The files are plain markdown.

**What if my AI already has memory features?**
Use both. Platform memory is controlled by the platform. These files are controlled by you. They also work across platforms, which built-in memory doesn't.

**How long should entries be?**
Short enough to scan, long enough to understand later. A few sentences to a few paragraphs. If you're writing pages, consider splitting into multiple entries.

**Can I change the format?**
Yes. These templates are starting points. Adapt them to how you work. The only thing that matters is: you can find what you need later, and you know where it came from.
